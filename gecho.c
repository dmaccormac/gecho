//+---------------------------------------------------------------------------
//
// PROGRAM:  GECHO.C - Windows GUI echo program
// AUTHOR: Dan MacCormac <dan@maccormac.net>
// DATE: 2024-12-16
// EXAMPLE: gecho "this is a test message"
// CREDIT: https://www.bellard.org/tcc/
//+---------------------------------------------------------------------------

#include <windows.h>

#define APPNAME "gecho"
        ...
        )
{
    ...
    pWindowText = lpCmdLine[0] ? lpCmdLine : "hello gecho";
